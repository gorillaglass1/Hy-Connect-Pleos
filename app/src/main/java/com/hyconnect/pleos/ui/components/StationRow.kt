...
private fun LocationPin(modifier: Modifier = Modifier) {
    Box(
        ...
        Canvas(modifier = Modifier.size(22.dp)) {
            drawCircle(color = HyBlue, radius = 8.dp.toPx(), center = Offset(size.width / 2f, 8.dp.toPx()))
            drawCircle(color = Color.White, radius = 3.dp.toPx(), center = Offset(size.width / 2f, 8.dp.toPx()))
            drawLine(
                color = HyBlue,
